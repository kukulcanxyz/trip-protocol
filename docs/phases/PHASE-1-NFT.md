...
| 1.4 | Tests | `feat/phase-1-tests` | ✅ Done | agent | 1.3 |
| 1.5 | Deploy testnet | `feat/phase-1-deploy` | ✅ Done | agent | 1.4 |
...
| 2026-02-06 | 1.4 | b806bb8 | 21 tests passing, PR #4 merged |
| 2026-02-06 | 1.5 | - | Deployed to Monad testnet: 0xF2e5...1e80 |
